...
jmx_url = lib.getconfig.getparam('Jolokia', 'jolokia')
check_type = 'jmx'
reaction = -3
            ...
            for itme in data_dict['value'].items():
                ...
                for o in ('CollectionCount', 'CollectionTime'):
                    ...
                    self.local_vars.append(
                        {'name': 'jmx_gc_' + o.lower(), 'timestamp': self.timestamp, 'value': vle, 'check_type': check_type, 'reaction': -1, 'extra_tag': {'gctype': nme}})
